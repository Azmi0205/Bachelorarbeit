...
#define VOLTAGE_V_Pin GPIO_PIN_0
#define VOLTAGE_V_GPIO_Port GPIOC
#define VOLTAGE_W_Pin GPIO_PIN_1
#define VOLTAGE_W_GPIO_Port GPIOC
#define VOLTAGE_BUS_Pin GPIO_PIN_0
#define VOLTAGE_BUS_GPIO_Port GPIOA
#define CURRENT_U_Pin GPIO_PIN_1
#define CURRENT_U_GPIO_Port GPIOA
#define LPUART1_TX_Pin GPIO_PIN_2
#define LPUART1_TX_GPIO_Port GPIOA
#define LPUART1_RX_Pin GPIO_PIN_3
#define LPUART1_RX_GPIO_Port GPIOA
#define EN_3_3V_Pin GPIO_PIN_4
...
#define VOLTAGE_U_Pin GPIO_PIN_14
#define VOLTAGE_U_GPIO_Port GPIOB
