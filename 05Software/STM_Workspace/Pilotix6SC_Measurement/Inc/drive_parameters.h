...
#define MAX_APPLICATION_SPEED_RPM          2130 /*!< rpm, mechanical */
#define MIN_APPLICATION_SPEED_RPM          (0 + (U_RPM / SPEED_UNIT)) /*!< rpm, mechanical, absolute value */
#define M1_SS_MEAS_ERRORS_BEFORE_FAULTS    50 /*!< Number of speed measurement errors before main sensor goes in fault */
...
#define SPEED_THRESHOLD_DEMAG              ((uint32_t)1800) /*!< Speed threshold above which the  RUN_DEMAGN_DELAY_MIN is applied */
...
#define PID_SPEED_KP_DEFAULT               3170/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT               418/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_VOLTAGE_THRESHOLD_V             16.7 /*!< Over-voltage threshold */
...
#define PHASE1_VOLTAGE_RMS                 2.24

/* Phase 2 */
#define PHASE2_DURATION                    1000 /* milliseconds */
#define PHASE2_FINAL_SPEED_UNIT            (320*SPEED_UNIT/U_RPM)
#define PHASE2_VOLTAGE_RMS                 5.24

/* Phase 3 */
#define PHASE3_DURATION                    500 /* milliseconds */
#define PHASE3_FINAL_SPEED_UNIT            (320*SPEED_UNIT/U_RPM)
#define PHASE3_VOLTAGE_RMS                 5.24

/* Phase 4 */
#define PHASE4_DURATION                    0 /* milliseconds */
#define PHASE4_FINAL_SPEED_UNIT            (0*SPEED_UNIT/U_RPM)
#define PHASE4_VOLTAGE_RMS                 2.24

/* Phase 5 */
#define PHASE5_DURATION                    0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT            (0*SPEED_UNIT/U_RPM)
#define PHASE5_VOLTAGE_RMS                 2.24

/* Sensor-less rev-up sequence */
#define ALIGN_STEP                         1 /*!< Step during rotor alignment*/

/* Observer start-up output conditions  */
#define OBS_MINIMUM_SPEED_RPM              320

#define NB_CONSECUTIVE_TESTS               5 /* corresponding to former NB_CONSECUTIVE_TESTS / (TF_REGULATION_RATE /  MEDIUM_FREQUENCY_TASK_RATE) */
